    ...
    <div class="row all">
        <div class="col liner">
            ...
            <div class="row">
                ...
                <div class="error" v-if="this.incorrectPassword">{{$t('security.passwordsNotEquals')}}</div>
            </div>

            <Button text="logIn" :onClick="createUser"/>
...
<style scoped>
.all {
    background: url("../../images/login-fourth-logo2.png") repeat-x;
}
